...
namespace UsedVehicleSystem.Controllers
{
    public class AdsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,AdTitle,AdCategory")] Ads ads)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,AdTitle,AdCategory")] Ads ads)
        {
            if (ModelState.IsValid)
            {
